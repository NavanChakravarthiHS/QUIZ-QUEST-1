...
import { Loader2, BookOpen, Mail, Lock, User, ArrowLeft, Sparkles, ClipboardCheck, BarChart3, Shield, Users } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-bold mb-4">Welcome, Teacher!</h2>
            <p className="text-xl text-emerald-100 mb-8">
              Create engaging, secure quizzes and track student progress with ease
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Create Quizzes</h3>
                <p className="text-emerald-100">Build custom quizzes with multiple question types</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-100">Monitor student performance and analytics</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-100">Generate unique access codes for each quiz</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            ...
            <p className="text-gray-600">Sign in to create and manage quizzes</p>
          </div>
          ...
          <Card className="border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center space-y-4 pb-8">
              ...
              <div>
                <CardTitle className="text-2xl font-bold text-gray-800">Teacher Portal</CardTitle>
                <CardDescription className="text-gray-600">Sign in to create and manage quizzes</CardDescription>
              </div>
            </CardHeader>
